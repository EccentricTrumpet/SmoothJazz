...
proto.grpc.testing.PlayerState.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    discardPile: (f = msg.getDiscardPile()) && proto.grpc.testing.Hand.toObject(includeInstance, f),
...
/**
 * optional Hand cards_on_hand = 1;
 * @return {?proto.grpc.testing.Hand}
 */
proto.grpc.testing.PlayerState.prototype.getCardsOnHand = function() {
  return /** @type{?proto.grpc.testing.Hand} */ (
    jspb.Message.getWrapperField(this, proto.grpc.testing.Hand, 1));
};
...
/**
 * optional Hand discard_pile = 2;
 * @return {?proto.grpc.testing.Hand}
 */
proto.grpc.testing.PlayerState.prototype.getDiscardPile = function() {
  return /** @type{?proto.grpc.testing.Hand} */ (
...
/** @param {?proto.grpc.testing.Hand|undefined} value */
proto.grpc.testing.PlayerState.prototype.setDiscardPile = function(value) {
  jspb.Message.setWrapperField(this, 2, value);
};


proto.grpc.testing.PlayerState.prototype.clearDiscardPile = function() {
  this.setDiscardPile(undefined);
};
 ...
 * @return {!boolean}
 */
proto.grpc.testing.PlayerState.prototype.hasDiscardPile = function() {
